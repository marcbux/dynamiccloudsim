...
import org.dcs.CloudletSchedulerGreedyDivided;
import org.dcs.DynamicHost;
import org.dcs.DynamicModel;
...
import org.dcs.workflow.io.TraceFileReader;
			...
			for (int i = 0; i < Parameters.numberOfRuns; i++) {
				...
				switch (Parameters.scheduler) {
					...
					case HEFT:					scheduler = new HEFTScheduler("HEFTScheduler", taskSlotsPerVm);
												break;
					default:					scheduler = new GreedyQueueScheduler("GreedyQueueScheduler", taskSlotsPerVm);
												break;
				}
				...
				TraceFileReader logFileReader = new TraceFileReader(new File(traceFile), true, true, ".*jpg");
